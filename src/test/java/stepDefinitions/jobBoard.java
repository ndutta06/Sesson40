...
public class jobBoard {
	...
	public void form_details() {
		...
		driver.findElement(By.xpath("//input[@id='user_login']")).sendKeys("JobBoardUser29");
		driver.findElement(By.xpath("//input[@id='email']")).sendKeys("jobboard29@email.com");
	...
	public void verify_user() {
		...
		driver.findElement(By.xpath("//input[@id='user-search-input']")).sendKeys("jobboard29@email.com");
		driver.findElement(By.xpath("//input[@id='search-submit']")).click();
		driver.manage().timeouts().implicitlyWait(3, TimeUnit.SECONDS);
		driver.getPageSource().contains("jobboard29@email.com");
	...
	public void keywords_search() {
		...
		driver.findElement(By.xpath("//input[@name=\"search_keywords\" and @placeholder=\"Keywords\"]"))
				.sendKeys("Selenium");
		driver.manage().timeouts().implicitlyWait(3, TimeUnit.SECONDS);
	...
	public void submit_the_form() throws Throwable {
		...
		driver.findElement(By.xpath(
				"//body/div[@id='page']/div[@id='content']/div[1]/div[1]/main[1]/article[1]/div[1]/form[1]/p[1]/input[4]"))
				.click();
		driver.manage().timeouts().implicitlyWait(3, TimeUnit.SECONDS);
