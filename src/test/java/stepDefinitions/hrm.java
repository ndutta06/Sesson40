...
public class hrm {
	...
	public void user_adds_a_Job_Vacancy() throws Exception {
		...
		driver.manage().timeouts().implicitlyWait(4, TimeUnit.SECONDS);
		driver.findElement(By.xpath("//input[@id='addJobVacancy_name']")).sendKeys("JobPosting29");
	...
	public void user_adds_a_candidate() throws Exception {
		...
		driver.findElement(By.xpath("//input[@id='addCandidate_firstName']")).sendKeys("Niladri");
		driver.findElement(By.xpath("//input[@id='addCandidate_lastName']")).sendKeys("Dutta");
		driver.findElement(By.xpath("//input[@id='addCandidate_email']")).sendKeys("test@gmail.com");
		driver.findElement(By.xpath("//input[@id='addCandidate_resume']")).sendKeys("C:\\Users\\NiladriDutta\\Desktop");
		driver.findElement(By.xpath("//input[@id='btnSave']")).click();
		Thread.sleep(3000);
	}
	...
	public void user_verifies_added_candidate() throws Exception {
		...
		name.sendKeys("Niladri Dutta");
		name.sendKeys(Keys.ENTER);
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);


		driver.findElement(By.id("btnSrch")).click();
		driver.getPageSource().contains("Niladri Dutta");
	...
	public void user_verifies_the_created_employee(String FirstName, String LastName) throws Exception {
		...
		driver.getPageSource().contains("UserL09");
